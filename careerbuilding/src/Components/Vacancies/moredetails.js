...
function moredetails() {
  return (
    <div>
      ...
      <div class=" flex justify-center items-center py-2 flex flex-wrap md:flex-nowrap ">
        ...
        <div className="bg-paleBlue px-2 pt-6 pb-8 mb-4 flex flex-col my-2 ">
          <div class="md:flex justify-between mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
              <label
                class="block uppercase tracking-wide text-darkerBlue text-s font-bold mb-2"
                for="job-name"
              >
                Job Name:
              </label>
          ...
          <div className="block uppercase tracking-wide text-darkerBlue text-s font-bold  py-8 pr-80 flex w-1/2">
           <div><label>
            ...
            <input
              class="w-full  bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-darkerBlue focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              id="uploadcv"
              type="file"
            ></input></div> 
