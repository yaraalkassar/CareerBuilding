...
export default function Connect() {
  return (
    <div className="flex justify-around lg:mx-auto items-center lg:pt-12 py-20 bg-paleBlue">
      <div className="flex xl:flex-row flex-col xl:justify-between justify-center items-center lg:ml-4">
        <div className="xl:mt-0 leading-relaxed  md:mx-0 lg:w-3/4 flex flex-col items-center">
          <h1 className="text-darkerBlue font-bold xl:text-4xl text-xl xl:w-2/3">
            {"Volunteering In Kurdistan"}
          </h1>
          <h6 className="text-darkerBlue xl:mt-8 mt-5 xl:text-base text-sm xl:w-1/2">
            {
